...
bool loadRawTexture(const char* filename, int w, int h, int n, int l)
{
...
void init()
{
	...
	loadRawTexture("m02_marble.raw", 512, 512, 3, 1);

	glBindTexture(GL_TEXTURE_2D, texID[2]);
	loadRawTexture("m02_marble.raw", 512, 512, 3, 2);

	glBindTexture(GL_TEXTURE_2D, texID[3]);
	loadRawTexture("m02_marble.raw", 512, 512, 3, 3);

	glBindTexture(GL_TEXTURE_2D, texID[0]);
	loadRawTexture("m02_marble.raw", 512, 512, 3, 0);
	// Keyboard cout << endl;
	...
	cout << endl;
	cout << "Keyboard	input:	m	for	the	marble wrapper example" << endl;
	cout << "Keyboard	input:	l	for	the marble wrapper example1" << endl;
	cout << "Keyboard	input:	b	for	the	marble wrapper example2" << endl;
	cout << "Keyboard	input:	d	for	the marble wrapper example3" << endl;
...
void render(GLFWwindow* widnow)
{
	...
	case 1://Checkerboard
	{
		glBindTexture(GL_TEXTURE_2D, texID[0]); // Marble ver2 texture
	...
	case 4: // Logo
	{
		glBindTexture(GL_TEXTURE_2D, texID[3]);	//	Marble ver1	texture
		drawTexturedSquare(textureNumRepeats);
	}
	break;
	case 5: // Cube
...
void keyboard(GLFWwindow* window, int key, int scancode, int action, int mods) {
	if (action == GLFW_PRESS || action == GLFW_REPEAT)
	{
		...
		case GLFW_KEY_M:	example = 1; textureNumRepeats = 1;	break;
		case GLFW_KEY_L:	example = 2; textureNumRepeats = 1;	break;
		case GLFW_KEY_B:	example = 3; textureNumRepeats = 1;	break;
		case GLFW_KEY_D:	example = 4; textureNumRepeats = 1;	break;
